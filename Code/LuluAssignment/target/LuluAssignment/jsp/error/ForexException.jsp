...
<table id="report">
	<caption class="errorHeader">Application Exception - Please check with Administrator</caption>
	<tr>
		<th>Name</th>
		<th>Value</th>
	</tr>
	<tr>
		...
		<td><s:property value="exception.getErrorCode()" /></td>
	</tr>
	<tr>
	</tr>
	<tr>
		<td>Exception Message:</td>
		<td><s:property value="exception.getMessage()" /></td>
	</tr>
	<tr>
	</tr>
	<tr>
